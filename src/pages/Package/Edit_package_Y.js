...
import { PostPackage,GetAllPackage, Getdetail, PatchPackage } from "../../service/Package_Y.service";
...
function Edit_package(){
    ...
    return (
        <>
        <Header_Y content={"Sửa Dạng Gói Tập"}/>
